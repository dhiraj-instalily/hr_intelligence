#!/usr/bin/env python3
"""
Test script for HR Intelligence MCP tools

This script directly tests the MCP tools without starting a server,
...
def test_role_search():
    ...
    # Call the search_by_role tool directly
...
def test_semantic_search():
    ...
    # Call the semantic_search_experience tool directly
...
def test_skill_search():
    ...
    # Call the find_skill_combinations tool directly
...
def test_education_search():
    ...
    # Call the search_by_education tool directly
...
def test_candidate_details(candidate_id):
    ...
    # Call the get_candidate_details tool directly
...
def main():
    ...
    console.print("[bold]HR Intelligence MCP Tools Test[/bold]")
    console.print("This script tests the MCP tools directly without starting a server.")
